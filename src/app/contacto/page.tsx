    ...
    <div className="min-h-screen">
      ...
      <section className="py-0">
        <div className="w-full h-[400px] md:h-[500px] bg-secondary-100">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2993.2918741384!2d2.0117947!3d41.5648531!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12a4967f1e6f4e1f%3A0x1234567890abcdef!2sAv.%20de%20Santa%20Eul%C3%A0lia%2C%20290%2C%2008223%20Terrassa%2C%20Barcelona!5e0!3m2!1ses!2ses!4v1234567890123"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
            ...
            title="Ubicación INTE SISTEMAS - Terrassa"
          ></iframe>
        </div>
      </section>
    </div>
